      ...
      <Container width="wide" className="lg:px-0">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)] lg:items-stretch lg:gap-16">
          <div className="pt-14 lg:py-24 lg:pl-12">
            <ChapterLabel number="01" title="Por qué estamos aquí" data-reveal />
            <p
              data-reveal
              data-reveal-delay="1"
              className="mt-8 max-w-[32rem] font-display text-[clamp(1.625rem,3vw,2.25rem)] leading-[1.18] text-ink"
            >
            ...
            <div
              data-reveal
              data-reveal-delay="2"
              className="mt-7 max-w-[31rem] space-y-5 font-serif text-[1.0625rem] leading-[1.8] text-ink-soft"
            >
              <p>
            ...
            <p
              data-reveal
              data-reveal-delay="3"
              className="label-caps mt-9 text-ink-muted"
            >
          ...
          <div
            data-reveal
            className="relative aspect-[4/3] w-full overflow-hidden bg-charcoal lg:aspect-auto lg:h-full lg:min-h-[32rem]"
          >
            <Image
