    ...
    <div className="border-t border-stone bg-paper">
      <Container width="wide">
        <div className="py-16 lg:py-24">
          ...
          <p className="mt-8 max-w-3xl font-display text-[clamp(1.5rem,3vw,2.25rem)] leading-[1.2] text-ink">
            Hoy somos mucho más pequeños que la visión que tenemos, y está
            bien.
          </p>
          <p className="mt-6 max-w-xl font-serif text-[1.0625rem] leading-[1.8] text-ink-soft">
